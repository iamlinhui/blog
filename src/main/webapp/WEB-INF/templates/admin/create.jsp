                        ...
                        <div class="tag-picker">
                            <div class="d-flex flex-wrap gap-2 align-items-center" style="min-height:34px;">
                                <c:forEach items="${terms}" var="term">
                                    <input type="checkbox" name="termId" value="${term.termId}" id="tag_c_${term.termId}" class="tag-picker-cb" hidden>
                                </c:forEach>
                            ...
                            <div class="tag-picker-menu">
                                <c:forEach items="${terms}" var="term">
                                    <label class="tag-picker-item" data-for="tag_c_${term.termId}">
