		...
		<div class="list-group">
			<form action="admin/create" method="post">
				<div class="input-group">
				  ...
				  <input name="postTitle" type="text" class="form-control input-sm" id="basic-url" aria-describedby="basic-addon3" required autofocus>
				</div>
				<br>
				<div class="input-group">
				  <span class="input-group-addon" id="basic-addon3">文章简介</span>
				  <input name="postExcerpt" type="text" class="form-control input-sm" id="basic-url" aria-describedby="basic-addon3" required>
				</div>
				<br>
				<div>
		          <label for="commentStatus">允许评论</label>
		          <input id="commentStatus" type="checkbox" name="commentStatus" checked="checked">
		        </div>
				<br>
		        <div>
				<label>文章分类 :</label>
				...
				<br>
			 	<!-- 加载编辑器的容器 -->
				 <div style="width:100%;">
	   				 <script id="editor" type="text/plain" style="height: 1080px;" name="postContent"></script>
				</div>
				<br>
